...
@RestController
@RequestMapping("/qualifying_title")
public class QualifyingTitleController {
    
    private final DocumentUserService documentUserService;

    public QualifyingTitleController(DocumentUserService pDocumentUserService) {
    ...
    public ResponseEntity<?> getDocument(@RequestParam String pIdUser) {
        ...
        DocumentResponseDTO myDTO = this.documentUserService.getQualifyingTitle(pIdUser);
    ...
    public ResponseEntity<?> getDownloadImage(@RequestParam String pIdUser) {
        ...
        String imageURL = this.documentUserService.getDownloadQualifyingTitle(pIdUser);
    ...
    public ResponseEntity<?> deleteDocument(@RequestParam String pIdUser, @RequestParam String pType) throws IOException {
        ...
        this.documentUserService.deleteQualifyingTitle(pIdUser, pType);
        ApiResponse<QualifyingTitleEntity> response = new ApiResponse<>("Documento eliminado!"
        , null
        );
